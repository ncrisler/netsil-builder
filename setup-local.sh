...
function display_usage() {
    echo "This script will setup Netsil AOC assuming you have already provisioned a VM.
          Usage: ./setup.sh -h hostname [-k ssh_key] [-a apps_dir] [-u username] [-d dcos_path] [-r registry] [-o offline] [-s auto-response]
